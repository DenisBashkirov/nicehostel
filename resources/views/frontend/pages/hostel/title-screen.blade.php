<div class="title-screen flex items-center xs-sm:h-468px md-xl:h-600px text-white" style="background-image: url({{ asset('img/hostels/' . $hostel->route . '/background.jpg') }})">
