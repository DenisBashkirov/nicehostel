    ...
    <div class="container">
        ...
        <div class="xs-sm:mt-40 md:mt-60 lg-xl:mt-40">
            ...
            <div class="lg-xl:flex lg:sx-60 xl:sx-120 xs-sm:mt-20 md-xl:mt-32">
                ...
                <a class="flex items-center xs-sm:mt-20 md:mt-32 xs-sm:text-20 md-xl:text-24 xs-sm:sx-4 md-xl:sx-8 no-underline text-black" href="mailto:info@nicehostel.org"><i class="icon-mail xs-sm:text-28 md-xl:text-32"></i><span>info@nicehostel.org</span></a>
            </div>
